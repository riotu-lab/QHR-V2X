...
```bash
python experiments/scripts/generate_comparison_charts.py --seeds 20 --repeats 3 --eta 0.3 --temperature 1.0 --candidate-size 8 --include-stochastic --include-repo-impl --repo-seeds 5
```
